  ...
  return (
    <Layout>
      <div className={styles.introContainer}>
        ...
        <p>I'm Paulo and I use this domain and the infra around it primarily for sandboxing and testing out new approaches to DevOps and database tooling, none of which
          ...
          management, powerlifting, running, gardening, and literature.</p>
